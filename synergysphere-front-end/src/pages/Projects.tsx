...
import { PlusIcon, FolderIcon, UserGroupIcon, CalendarIcon, XMarkIcon, TrashIcon, PencilIcon, ClockIcon } from '@heroicons/react/24/outline';
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={() => {
                      ...
                      toast.success('Invite members functionality coming soon!');
                    }}
                    className="w-full flex items-center gap-3 px-4 py-3 text-left text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                  >
